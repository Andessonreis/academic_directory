...
//  Destinatário: aluno (se não for anônimo e tiver email)
//  Disparado: quando a manifestação é salva com sucesso
// ─────────────────────────────────────────────────────────────
...
export function feedbackReceivedTemplate(payload: FeedbackReceivedPayload): {
  subject: string
  html: string
} {
  ...
  return {
    subject: `Recebemos sua ${tipoLabel} — DA IFBA Irecê`,
    html: `
<!DOCTYPE html>
<html lang="pt-BR">
        ...
        <tr>
          <td style="background:#141414;padding:24px 32px;border-bottom:1px solid #2a2a2a;">
            ...
            <h1 style="margin:8px 0 0;font-size:22px;font-weight:700;color:#fff;">
              Sua mensagem foi <span style="color:#22c55e;">recebida ✓</span>
            </h1>
          </td>
        </tr>
        ...
        <tr>
          <td style="padding:32px;">
            ...
            <p style="margin:0 0 24px;font-size:15px;color:#a3a3a3;line-height:1.7;">
              Recebemos sua <strong style="color:#e5e5e5;">${tipoLabel}</strong> e ela já está sendo analisada
              pela equipe do Diretório Acadêmico do IFBA Irecê.
            ...
            <div style="background:#111;border:1px solid #2a2a2a;border-radius:10px;padding:20px;margin-bottom:24px;">
              ...
              <p style="margin:0;font-size:14px;color:#a3a3a3;line-height:1.65;white-space:pre-wrap;">${escapeHtml(payload.conteudo)}</p>
            </div>
