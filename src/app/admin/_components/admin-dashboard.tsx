...
import { Calendar, Users, Newspaper, LogOut } from "lucide-react"
    ...
    <div className="min-h-screen bg-[#030303]">
      ...
      <div className="container mx-auto px-4 py-8">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="grid w-full max-w-2xl mx-auto grid-cols-3 bg-white/5 border border-white/10 p-1">
            <TabsTrigger
              value="events"
